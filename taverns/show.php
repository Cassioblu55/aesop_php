			...
			<div class="col-md-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="col-md-12">
							<h4>Owner</h4>
							<div><a ng-href="/aesop/characters/show.php?id={{owner.id}}">{{owner.name}}</div>
						</div>
					</div>
					<div class="panel-footer">
						<a ng-href="/aesop/taverns/" class="btn btn-info">Show All</a>
						<a ng-href="/aesop/taverns/edit.php?id={{tavern.id}}" class="btn btn-primary">Edit</a>
