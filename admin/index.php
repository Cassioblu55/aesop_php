...
app.controller("AdminIndexController", ['$scope', "$controller" , function($scope, $controller){
	...
	$scope.gridModel.columnDefs = [	{field: 'username'},{field: 'email'},
	                           		...
	                           		{field: 'delete', enableFiltering: false, width: 67,  cellTemplate: '<button class="btn btn-danger" ng-click="grid.appScope.deleteUser(row.entity.id,row.entity.username);">Delete</button>'}
	                           	];
