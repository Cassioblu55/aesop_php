		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<label>Amount</label> <input type="number" class="form-control"
					min=0 ng-model="newDice.amount"> <label>Kind</label> <input
					type="number" class="form-control" min=0 ng-model="newDice.kind"> <label>Modifer</label>
				<input type="number" class="form-control" min=0
					ng-model="newDice.modifer">
				<div class='row'>
