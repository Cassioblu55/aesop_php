...
require_once '../src/generator/settlement.php';
		...
		<div
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<input type="text" class="form-control"  name="name" ng-model="settlement.name" placeholder= "Settlement Name" />
				</div>
				<div class="form-group">
					<label for="known_for">Known For</label> 
					<input type="text" class="form-control"  name="known_for" ng-model="settlement.known_for" placeholder="Known For" />
				</div>
				<div class="form-group">
					<label for="notable_traits">Notable Trait</label>
					<input type="text" class="form-control"  name="notable_traits" ng-model="settlement.notable_traits" placeholder="Notable Trait"/>
				</div>
				<div class="form-group">
					<label for="ruler_status">Ruler Status</label>
					<input type="text" class="form-control"  name="ruler_status" ng-model="settlement.ruler_status" placeholder="Ruler Status"/>
				</div>
				<div class="form-group">
					<label for="race_relations">Race Relations</label>
					<input type="text" class="form-control"  name="race_relations" ng-model="settlement.race_relations" placeholder="Race Relations"/>
				</div>
				<div class="form-group">
					<label for="current_calamity">Current Calamity</label>
					<input type="text" class="form-control"  name="current_calamity" ng-model="settlement.current_calamity" placeholder="Current Calamity"/>
				</div>
				<div class="form-group">
					<label for="ruler_id">Ruler</label>
					<select class="form-control"  name="ruler_id">
						<option value="">Any</option>
						<option ng-repeat="character in characters" value={{character.id}} ng-selected="settlement.ruler_id == character.id">{{character.name}}</option>
					</select>
				</div>
				<div class="form-group">
					<label for="population">Population</label>
					<input type="number" class="form-control"  name="population" ng-model="settlement.population" placeholder="Population"/>
				</div>
				<div class="form-group">
				...
				<div style='<?php if($added){echo "color:#5cb85c";}else{echo "display:none";}?>'>Added Settlement</div>
			</div>
		</div>
	</div>
