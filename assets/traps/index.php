...
<div ng-controller="TrapIndexController">
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading clearfix">
						<h4 class="panel-title pull-left" style="padding-top: 7.5px;">Traps</h4>
...
<script>
app.controller("TrapIndexController", ['$scope', "$http" , function($scope, $http){
	...
	$scope.gridModel.columnDefs = [	{field: 'show', enableColumnMenu: false, enableFiltering: false, width: 65, cellTemplate: '<a class="btn btn-info" role="button" ng-href="show.php?id={{row.entity.id}}">Show</a>'},
	                               	...
	                               	{field: 'name',  enableColumnMenu: false},{field: 'description', enableColumnMenu: false},
