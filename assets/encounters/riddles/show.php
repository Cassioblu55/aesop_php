	...
	<div class="col-md-12">
		<div class="panel panel-default">
					...
					<div class="col-md-6">
						<div class="panel panel-default">
							<div class="panel-heading clearfix">
								...
								<button class="btn btn-primary btn-sm pull-right" type="button" ng-click="showHint = !showHint">{{(showHint) ? "Hide" : "Show"}}</button>
							</div>
					...
					<div class="col-md-6">
						<div class="panel panel-default">
							<div class="panel-heading clearfix">
								...
								<button class="btn btn-primary btn-sm pull-right" type="button" ng-click="showSolution = !showSolution">{{(showSolution) ? "Hide" : "Show"}}</button>
							</div>
			...
			<div class="panel-footer">
				...
				<a ng-href="edit.php?id={{riddle.id}}" class="btn btn-primary">Edit</a>
				<button ng-click="deleteById(riddle.id,riddle.name, redirectToIndex)" class="btn btn-danger">Delete</button>
				</div>
		</div>
	</div>	
