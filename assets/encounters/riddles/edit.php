		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<input type="text" class="form-control"  name="name" ng-model="riddle.name" placeholder="Name" />				
				</div>
				<div class="form-group">
					<label for="riddle">Riddle</label>
					<textarea type="text" class="form-control"  rows="4" name="riddle" ng-model="riddle.riddle" placeholder="Riddle"></textarea>				
				</div>
				<div class="form-group">
					<label for="solution">Solution</label>
					<textarea type="text" class="form-control" rows="4" name="solution" ng-model="riddle.solution" placeholder="Solution"></textarea>				
				</div>
				<div class="form-group">
					<label for="hint">Hint</label>
					<textarea type="text" class="form-control" rows="4" name="hint" ng-model="riddle.hint" placeholder="Hint"></textarea>				
				</div>
				<div class="form-group">
					<label for="weight">Weight</label>
					<input type="number" class="form-control"  name="weight" ng-model="riddle.weight" placeholder="Weight" />				
				</div>
				<div class="form-group">
